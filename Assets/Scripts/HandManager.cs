...
public class HandManager : MonoBehaviour
{
    ...
    public void RemoveCardFromHand(GameObject card)
    {
        if (cardsInHand.Contains(card))
        {
            ...
            // If you want to destroy the UI card (since lane now holds it), do not destroy here.
            // But since we parent the placed card under the lane, we shouldn't Destroy it here.
            // So just reparenting was already done in Lane.PlaceCard => we keep object alive.
            UpdateHandVisuals();
        }
    }
